...
public class MealRestController {
    ...
    public void delete(int id) {
        int userId = SecurityUtil.authUserId();
        log.info("delete meal by id {} for user with id {}", id, userId);
    ...
    public void update(Meal meal, int id) {
        ...
        log.info("update {} for user with userId={}", meal, userId);
    ...
    public List<MealTo> getBetweenHalfOpen(@Nullable LocalDate startDate, @Nullable LocalTime startTime,
        ...
        List<Meal> mealsDateFiltered = mealService.getBetweenHalfOpen(startDate, endDate, userId);
